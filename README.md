...
1. 安装公共基础包：
    ...
    ```bash
    go get -v -u github.com/sesky4/tgo/tencentcloud/common
    ```

2. 安装对应的产品包(如cvm):

    ```bash
    go get -v -u github.com/sesky4/tgo/tencentcloud/cvm
    ```
...
```bash
go get -v -u github.com/sesky4/tgo
```
...
前往代码托管地址 [Github](https://github.com/sesky4/tgo) 或者 [Gitee](https://gitee.com/tencentcloud/tencentcloud-sdk-go) 下载最新代码，解压后安装到 $GOPATH/src/github.com/tencentcloud 目录下。
...
更多示例参见 [examples](https://github.com/sesky4/tgo/tree/master/examples) 目录。对于复杂接口的 Request 初始化例子，可以参考 [例一](examples/cvm/v20170312/run_instances.go) 。对于使用json字符串初始化 Request 的例子，可以参考 [例二](examples/cvm/v20170312/describe_instances.go) 。
...
5. 凭证提供链
    ...
    更详细的使用方式请参考示例：[使用ProviderChain](https://github.com/sesky4/tgo/blob/master/testing/integration/provider_chain_test.go)
...
详细使用请参阅示例：[使用 Common Client 进行调用](https://github.com/sesky4/tgo/blob/master/examples/common/common_client.go)
...
更多用法参考[测试文件](https://github.com/sesky4/tgo/tree/master/tencentcloud/common/netretry_test.go)
